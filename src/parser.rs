...
fn infix_parser(kind: tokenizer::Kind) -> Option<InfixParser> {
    match kind {
        ...
        tokenizer::Kind::And => Some(InfixParser::BinaryOp(AND, BinaryOp::And)),
        tokenizer::Kind::Or => Some(InfixParser::BinaryOp(OR, BinaryOp::Or)),
        tokenizer::Kind::Xor => Some(InfixParser::BinaryOp(XOR, BinaryOp::Xor)),
